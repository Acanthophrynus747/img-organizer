...
try:
    ...
    print("----------------------------------------------------------------------------------------------------------------")
    input("Press Enter to select the desired source directory:")
    ...
    print(f"Moving {num_images} images from {source_dir_path}")
    print("")

    input("Press Enter to select the desired destination directory:")

    destination_dir_path = filedialog.askdirectory()

    print(f"Moving organized images to {destination_dir_path} in folders by date")
    print("")
